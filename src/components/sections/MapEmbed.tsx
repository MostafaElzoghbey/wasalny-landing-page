                    ...
                    {isMapVisible ? (
                        ...
                        >
                            <div className="bg-[hsl(var(--card))] p-4 rounded-full shadow-lg mb-4 pointer-events-none mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary-600 dark:text-primary-500" role="img" aria-labelledby="map-pin-title">
                                    <title id="map-pin-title">أيقونة دبوس الخريطة</title>
