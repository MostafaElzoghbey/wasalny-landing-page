                ...
                <div className="w-full h-[400px] rounded-3xl overflow-hidden shadow-2xl bg-gray-100 dark:bg-gray-800 relative group">
                    {isMapVisible ? (
                        ...
                        <div
                            ...
                            className="absolute inset-0 flex flex-col items-center justify-center cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
                        >
