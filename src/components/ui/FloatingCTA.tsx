...
export function FloatingCTA() {
  ...
  useEffect(() => {
    // Create ScrollTrigger to detect when hero section is passed
    const trigger = ScrollTrigger.create({
      trigger: '#home', // Hero section has id="home"
      start: 'bottom top+=100', // When hero bottom passes 100px from viewport top
  ...
  // WhatsApp pulse animation (continuous)
  useGSAP(() => {
    ...
    >
      ...
      <a 
        ...
        className={cn(
          ...
          "text-gray-600 dark:text-gray-300 hover:text-[#1877F2]",
      ...
      >
        <div ref={pulseRef} className="absolute inset-0 rounded-full bg-[#25D366] -z-10"></div>
